...
{
    std::cout << "\033[32mParameterised constructor called\033[0m" << std::endl;
}
////////////////////////////////////////////////////
...
void ClapTrap::attack(const std::string& target)
{
    ...
    if (!this->hit_pt)
    {
        std::cout << this->name << " cannot attack " << target << ", " << this->name << " has no hit points left."<< std::endl;
        return ;
    }
    if (!this->energy_pt)
    {
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
		this->hit_pt = 0;
    	std::cout << this->name << " was attacked! Now has " << this->hit_pt << " hits points." << std::endl;
	}
    else
    {
		this->hit_pt -= amount;
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (!this->energy_pt)
    {
        std::cout << this->name << " cannot be repaired, " << this->name << " has already died." << std::endl;
        return ;
    }
    this->energy_pt--;
    this->hit_pt += amount;
